...
await parseResult.WithParsedAsync<ImportFromRomOptions>(async options => await ImporterProcessor.ImportMapFromRomAsync(options.InputFilePath, options.OutputDirectoryPath, options.MapName, options.Silent));
